 ...
 */
public class SubmitActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailView = (AutoCompleteTextView) findViewById(R.id.latitude);
        populateAutoComplete();

        mPasswordView = (EditText) findViewById(R.id.longitude);
        mPasswordView.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            @Override
            public boolean onEditorAction(TextView textView, int id, KeyEvent keyEvent) {
                if (id == R.id.latitude || id == EditorInfo.IME_NULL) {
                    attemptLogin();
                    return true;
                }
                return false;
        ...
        submitButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(SubmitActivity.this, "Report Submitted", Toast.LENGTH_LONG).show();
                finish();
            }
        });
...
// Apply the adapter to the spinner
        ...
        Spinner disabilitySpinner = (Spinner) findViewById(R.id.disability_spinner);
// Create an ArrayAdapter using the string array and a default spinner layout
        ArrayAdapter<CharSequence> disabilityAdapter = ArrayAdapter.createFromResource(this,
...
// Apply the adapter to the spinner
        ...
        Spinner issueSpinner = (Spinner) findViewById(R.id.issue_spinner);
// Create an ArrayAdapter using the string array and a default spinner layout
...
//                new ArrayAdapter<>(SubmitActivity.this,
